...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const CScript genesisOutputScript = CScript() << ParseHex("045eca3f63a4de782fdff44b73e9634d6ebcba857d5b436569b5e4cb50a6ebb2175372c5489585ad583efb3067f934dd421acd09a70a4081654ca82fbd508805f2") << OP_CHECKSIG;
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1711390455, 566, 0x20001fff, 4, 5000 * COIN);
        VerifyGenesisPOW(genesis);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x1a219061d6a385f0528a851a97b07f2938eb9c63fac4338530b51befbea8101f"));
        assert(genesis.hashMerkleRoot == uint256S("0xa7d5b0e7e6b3e3a1209ed6568464c4920944ab7d7441c4d0089c2c3c58f36ccf"));
        ...
        vSporkAddresses = {"TDPaZHmAc4A2J3ZaQ8zFnhTriSkbaQPgEt"};
        nMinSporkKeys = 1;
        fBIP9CheckSmartnodesUpgraded = true;

        checkpointData = {
            {{566, uint256S("0x1a219061d6a385f0528a851a97b07f2938eb9c63fac4338530b51befbea8101f")}}};
